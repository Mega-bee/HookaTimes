...
namespace HookaTimes.BLL.IServices
{
    public interface ICartBL
    {
        ...
        Task<ResponseModel> RemoveItemFromCart(int productId, int userBuddyId, string cartSessionId= null);
        Task<ResponseModel> ClearCart(int userBuddyId, string cartSessionId = null);
        Task<ResponseModel> UpdateCart(List<UpdateCartItem_VM> items, int userBuddyId, string cartSessionId = null);
