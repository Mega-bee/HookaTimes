...
namespace HookaTimes.MVC.Areas.Distributor.Controllers
{
    ...
    public class InventoryController : Controller
    {
        ...
        public IActionResult Stocks()
        {
            ...
            return View("~/Areas/Distributor/Views/Pages/Inventory/Stocks.cshtml", stocksList);
        }
        ...
        public IActionResult Orders()
        {
            ...
            return View("~/Areas/Distributor/Views/Pages/Inventory/Orders.cshtml", ordersList);
        }

        public IActionResult CreateOrder()
        {
            return View("~/Areas/Distributor/Views/Pages/Inventory/CreateOrder.cshtml");
        }
